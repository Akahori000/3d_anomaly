...
dictionary_dir =  './data/objset3/calculated_features_all/model1_' + Anomaly_object + '/both_features/' + dic_folder + '/'
test_dir = './data/objset3/calculated_features_all/model1_' + Anomaly_object + '/both_features/' + test_folder + '/'
