...
dictionary_dir =  './data/calculated_features_random/model1_' + Anomaly_object + '/both_features/' + dic_folder + '/'
test_dir = './data/calculated_features_random/model1_' + Anomaly_object + '/both_features/' + test_folder + '/'
...
#             path = './data/calculated_features_random/model1_' + Anomaly_object + '/both_features/c_epoc_' + epoc + '_data' + testn[Anomaly_object] + '/'
#             print(path)
